...
defmodule Solution do
  def dijkstra(lines) do
    ...
    step(field, {sr, sc}, target_height)
  end

  defp step(field, {r, c}, th) do
    ...
    if h == th, do: d, else: step(field, {nr, nc}, th)
  end
...
IO.puts("The shortest path through this mess to the bottom is #{Solution.dijkstra(lines)}")
